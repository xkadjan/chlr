...
#    camera.digital_gain = 100
    ...
    camera.shutter_speed = 5 #camera.exposure_speed
...
# =============================================================================
        ...
        try:
            ...
            print(" - new intit, awb_gains: ", awb_gains_set)
        repos,currtime = MakeRepository(path)
        logfile = MakeLogfile(repos,currtime)
    
        print ("_" * 70)
        print("Measurement:")
        print(" - touch button for capture, hold for new measurement")
...
#               LED.ChangeDutyCycle(20)
                ...
                sleep(0.8)            
                if GPIO.input(15) > 0:
                    print(" - new measurement will be created")
                    GPIO.output(16, GPIO.LOW)
                    sleep(2)
                    GPIO.output(16, GPIO.HIGH)
                    break
                ...
                for loop in range(5):
                    ...
                    b = B_ / (R_ + G_ + B_)
                    ExG_n = 2 * g - r - b
                    print(measurement, loop, "ExG_n: ", ExG_n) 
